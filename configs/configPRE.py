...
class Config():
    ...
    FEATURE_NET_NAME= 'wfe4'
    PYTORCH_FEATURE_NET= False 
    USE_PRETRAINED_WEIGHTS = False 
    FULL_MODEL_LOAD_NAME= 'TDID_pre_04a_14001_3.29401.h5'
    LOAD_FULL_MODEL= False 
    MODEL_BASE_SAVE_NAME = 'TDID_pre_06'
    SAVE_FREQ = 2000
    SAVE_BY_EPOCH = False 
    ...
    TRAIN_OBJ_IDS=[cid for cid in range(1,1800) if cid not in OBJ_IDS_TO_EXCLUDE] 
