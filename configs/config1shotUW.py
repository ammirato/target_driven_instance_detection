...
class Config():
    ...
    #TARGET_IMAGE_DIR= BASE_DIR + 'instance_detection_targets/uw_1shots/'
    ...
    MODEL_BASE_SAVE_NAME = 'TDID_1shotUW_04'
    SAVE_FREQ = 2000
    SAVE_BY_EPOCH = False 
    #BATCH_NORM= True
    ...
    ID_TO_NAME = {}
    NAME_TO_ID = {}
    #OBJ_IDS_TO_EXCLUDE = [32,33,37,40,43,44,47,48,49,53,55,58,59,61,65,67,70,71,74,76,77,78,80,83,84,85,87,88,89,90,91,92,95,98,99]
    OBJ_IDS_TO_EXCLUDE = [32,33]#,37,40,43,44,47,48,49,53,55,58,59,61,65,67,70,71,74,76,77,78,80,83,84,85,87,88,89,90,91,92,95,98,99]

    TRAIN_OBJ_IDS= [x for x in range(1,111)  if x not in OBJ_IDS_TO_EXCLUDE]
