...
class TDID(nn.Module):
    ...
    def __init__(self):
        ...
        self.sim_conv1 = Conv2d(2*self.groups+512,3*512, 3, relu=True, same_padding=True)
        self.sim_conv2 = Conv2d(2*self.groups+512,2*self.groups, 3, relu=True, same_padding=True)
        self.sim_conv3 = Conv2d(2*self.groups,512, 3, relu=False, same_padding=True)
