...
def anchor_target_layer(rpn_cls_score, gt_boxes, im_info, _feat_stride=[16, ],
    ...
    #rs_shape = rpn_cls_score.shape
    #rpn_scores = rpn_cls_score.reshape(1,2,-1,rs_shape[-1])
    ...
    all_labels = []
    all_rpn_bbox_targets = []
    all_rpn_bbox_inside_weights = []
    all_rpn_bbox_outside_weights = []
    ...
    for batch_ind in range(batch_size):
        ...
        all_labels.append(rpn_labels)
        all_rpn_bbox_targets.append(rpn_bbox_targets)
        all_rpn_bbox_inside_weights.append(rpn_bbox_inside_weights)
        all_rpn_bbox_outside_weights.append(rpn_bbox_outside_weights)
