...
class TDID(nn.Module):
    ...
    def __init__(self):
        ...
        self.conv1 = Conv2d(2,512, 3, relu=True, same_padding=True)
    ...
    def forward(self, target_data, im_data, gt_boxes=None, features_given=False, im_info=None):
        ...
        for b_ind in range(img_features.size()[0]):
            ...
            cc1 = F.conv2d(sample_img,sample_targets1.permute(1,0,2,3),padding=padding)#,groups=self.groups) 
            cc2 = F.conv2d(sample_img,sample_targets2.permute(1,0,2,3),padding=padding)#,groups=self.groups) 
