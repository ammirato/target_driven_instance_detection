...
class Config():
    ...
    GROUND_TRUTH_BOXES = BASE_DIR + 'RohitCOCOgt/all_gmu.json'
    ...
    MODEL_BASE_SAVE_NAME = 'TDID_GEN4GMU_10'
    SAVE_FREQ = 5000
    SAVE_BY_EPOCH = False 
    #BATCH_NORM= True
    ...
    VAL_OBJ_IDS = [5,50,10,12,14,79,28,94,96,18,21] 
    ...
    #VID dataset
    USE_VID = False 
    VID_MAX_MIN_TARGET_SIZE = [200,50]
