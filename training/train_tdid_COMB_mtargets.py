...
save_name_base = 'TDID_COMB_archDmtScales_ROI_1'
...
target_size = [200,16]
#CREATE TRAIN/TEST splits
train_set = VID_Loader(VID_data_path,'train_single', target_size=target_size, multiple_targets=True, batch_size=batch_size)
