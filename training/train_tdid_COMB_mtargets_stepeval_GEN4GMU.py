...
save_name_base = 'TDID_final_GEN4GMU_0'
...
trained_model_path = ('/net/bvisionserver3/playpen/ammirato/Data/Detections/' +
                     '/saved_models/')
trained_model_name = 'TDID_final_GEN4GMU_0_0_6000_131.28783_0.41657_-1.00000.h5'
...
val_chosen_ids = [[18,50,79,94,96], []] #, [5,10,17]]#chosen_ids #range(0,28)#for validation testing
