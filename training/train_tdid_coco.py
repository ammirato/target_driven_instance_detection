...
from instance_detection.testing.test_tdid_coco import test_net, im_detect
...
save_name_base = 'TDID_final_GMU2AVD_coco_1'
...
chosen_ids =  [5,10,12,14,21,28]
val_chosen_ids = [[5,10,12,14,21,28],[5,10,12,14,21,28]] #, [5,10,17]]#chosen_ids #range(0,28)#for validation testing
...
#            )
        ...
        if step % save_freq == 0:
            ...
            #test net on some val data
                ...
                t_output_dir='/net/bvisionserver3/playpen/ammirato/Data/Detections/coco_dets/'
                ...
                gt_path = '/net/bvisionserver3/playpen10/ammirato/Data/RohitCOCOgt/avd_split1.json'


                m_ap = coco_det_eval(gt_path, t_output_dir+model_name+'.json',catIds=vci)
                m_aps.append(m_ap)
            net.train()
            if use_batch_norm:
                net.features.eval()
