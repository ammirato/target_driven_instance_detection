...
#from instance_detection.model_defs.tdid_nodepthwise_mtargets_batch import TDID 
...
save_name_base = 'TDID_final_AVD2_0'
#save_name_base = 'TDID_nodepthwise_AVD2_0'
...
val_chosen_ids = [[1,5,9,17,21,28,29], []] #, [5,10,17]]#chosen_ids #range(0,28)#for validation testing
