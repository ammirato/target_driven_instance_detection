...
save_name_base = 'TDID_final_GEN4AVD_0'
...
excluded_cids = range(32) + [53,76,78,79,82,86,16,33,32,   18,50,79,94,96] #10, 5,11,12,14]
#excluded_cids = [8,18]
...
val_chosen_ids = [range(32), []] #, [5,10,17]]#chosen_ids #range(0,28)#for validation testing
